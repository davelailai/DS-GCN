...
work_dir = './work_dirs_sparse/stgcn_new/stgcn_pyskl_ntu60_xsub_3dkp/j_sparse0.99'
train_pipeline = [
...
load_from='./work_dirs_sparse/stgcn/stgcn_pyskl_ntu60_xsub_3dkp/j_full/latest.pth'
