...
data = dict(
    ...
    test=dict(
        ...
        mc_cfg=mc_cfg))
# optimizer
optimizer = dict(module = dict(type='SGD', lr=0.4, momentum=0.9, weight_decay=0.0001))  # this lr is used for 8 gpus
optimizer_config = dict(type='MultiModuleHook',grad_clip=dict(max_norm=40, norm_type=2))
# learning policy
