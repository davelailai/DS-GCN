...
class LGA(nn.Module):
    ...
    def __init__(self,
        ...
        if self.in_channels != self.base_channels:
            modules = [STGCNBlock(in_channels, hidden_channels, A.clone(), residual=False)]
        for i in range(0, layer):
            modules.append(STGCNBlock(in_channels, out_channels, A.clone(), stride=2, residual=False))
