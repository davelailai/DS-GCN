...
def train_model(model,
    ...
    # optimizer = sparse_optimizers(model,cfg.optimizer)

    Runner = EpochBasedSparseRunner
    runner = Runner(
        model,
        optimizer=optimizer,
